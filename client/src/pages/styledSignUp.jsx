...
export const Container = styled.div`
  ...
  &:before {
    ...
    width: 100%;
    height: 50px;
    background: linear-gradient(to top, #3751e0, transparent);
    z-index: 10000;
  }
`
...
export const SpanEmail = styled.span`
  ...
  `
export const InputEmailCheck = styled.input`
    width: 100%;
    font-size: 16px;
...
export const SenhaInputContainer = styled.div`
    ...
    width: 94%;
`
export const InputSenhaCheck = styled.input`   
    width: 100%;
    font-size: 16px;
    background-color: transparent;
    border: none;
  ...
  `
export const InputUsernameCheck = styled.input`
    width: 100%;
    font-size: 16px;
    background-color: transparent;
    border: none;
